...
{
    public class AdventureWorksPerson_Command_MeshProcessor : BaseMeshProcessor
    {
        public AdventureWorksPerson_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          AdventureWorksPersonConstants.ProviderId;
