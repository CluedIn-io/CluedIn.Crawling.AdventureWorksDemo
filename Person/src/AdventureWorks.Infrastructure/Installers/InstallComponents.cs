...
namespace CluedIn.Crawling.AdventureWorksPerson.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IAdventureWorksPersonClientFactory>().AsFactory().OnlyNewServices())
                .Register(Component.For<AdventureWorksPersonClient>().LifestyleTransient().OnlyNewServices());
