...
{
    public class AdventureWorksProduction_Command_MeshProcessor : BaseMeshProcessor
    {
        public AdventureWorksProduction_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          AdventureWorksProductionConstants.ProviderId;
