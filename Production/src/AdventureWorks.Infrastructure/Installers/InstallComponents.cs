...
namespace CluedIn.Crawling.AdventureWorksProduction.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IAdventureWorksProductionClientFactory>().AsFactory().OnlyNewServices())
                .Register(Component.For<AdventureWorksProductionClient>().LifestyleTransient().OnlyNewServices());
