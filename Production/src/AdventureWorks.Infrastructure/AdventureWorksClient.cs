...
namespace CluedIn.Crawling.AdventureWorksProduction.Infrastructure
{
    ...
    public class AdventureWorksProductionClient
    {
        private const string BaseUri = "http://sample.com";

        private readonly ILogger<AdventureWorksProductionClient> _log;
        private readonly AdventureWorksProductionCrawlJobData _jobData;
        private readonly int _retryIntervalMs = 10000;

        public AdventureWorksProductionClient(ILogger<AdventureWorksProductionClient> log, AdventureWorksProductionCrawlJobData AdventureWorksProductionCrawlJobData) // TODO: pass on any extra dependencies
        {
            if (AdventureWorksProductionCrawlJobData == null)
            {
                throw new ArgumentNullException(nameof(AdventureWorksProductionCrawlJobData));
            }

            _jobData = AdventureWorksProductionCrawlJobData;
