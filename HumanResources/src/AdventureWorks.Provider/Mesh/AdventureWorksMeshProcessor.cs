...
{
    public class AdventureWorksHumanResources_Command_MeshProcessor : BaseMeshProcessor
    {
        public AdventureWorksHumanResources_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          AdventureWorksHumanResourcesConstants.ProviderId;
