...
namespace CluedIn.Crawling.AdventureWorksHumanResources.Vocabularies
{
...
KeyPrefix = "AdventureWorksHumanResources.HumanResourcesEmployeeDepartmentHistory"; // TODO: Set value
KeySeparator = ".";
