...
namespace CluedIn.Crawling.AdventureWorksHumanResources.Infrastructure
{
    ...
    public class AdventureWorksHumanResourcesClient
    {
        private const string BaseUri = "http://sample.com";

        private readonly ILogger<AdventureWorksHumanResourcesClient> _log;
        private readonly AdventureWorksHumanResourcesCrawlJobData _jobData;
        private readonly int _retryIntervalMs = 10000;

        public AdventureWorksHumanResourcesClient(ILogger<AdventureWorksHumanResourcesClient> log, AdventureWorksHumanResourcesCrawlJobData AdventureWorksHumanResourcesCrawlJobData) // TODO: pass on any extra dependencies
        {
            if (AdventureWorksHumanResourcesCrawlJobData == null)
            {
                throw new ArgumentNullException(nameof(AdventureWorksHumanResourcesCrawlJobData));
            }

            _jobData = AdventureWorksHumanResourcesCrawlJobData;
