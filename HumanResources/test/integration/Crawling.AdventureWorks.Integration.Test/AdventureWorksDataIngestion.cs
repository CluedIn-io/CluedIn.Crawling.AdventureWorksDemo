...
{
    public class DataIngestion : IClassFixture<AdventureWorksHumanResourcesTestFixture>
    {
        private readonly AdventureWorksHumanResourcesTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(AdventureWorksHumanResourcesTestFixture fixture, ITestOutputHelper output)
        {
