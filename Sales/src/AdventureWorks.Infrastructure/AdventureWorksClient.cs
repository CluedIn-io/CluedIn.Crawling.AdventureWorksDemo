...
namespace CluedIn.Crawling.AdventureWorksSales.Infrastructure
{
    ...
    public class AdventureWorksSalesClient
    {
        private const string BaseUri = "http://sample.com";

        private readonly ILogger<AdventureWorksSalesClient> _log;
        private readonly AdventureWorksSalesCrawlJobData _jobData;
        private readonly int _retryIntervalMs = 10000;

        public AdventureWorksSalesClient(ILogger<AdventureWorksSalesClient> log, AdventureWorksSalesCrawlJobData AdventureWorksSalesCrawlJobData) // TODO: pass on any extra dependencies
        {
            if (AdventureWorksSalesCrawlJobData == null)
            {
                throw new ArgumentNullException(nameof(AdventureWorksSalesCrawlJobData));
            }

            _jobData = AdventureWorksSalesCrawlJobData;
