...
namespace CluedIn.Crawling.AdventureWorksSales.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IAdventureWorksSalesClientFactory>().AsFactory().OnlyNewServices())
                .Register(Component.For<AdventureWorksSalesClient>().LifestyleTransient().OnlyNewServices());
