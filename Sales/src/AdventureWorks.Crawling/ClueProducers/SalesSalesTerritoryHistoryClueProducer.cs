...
namespace CluedIn.Crawling.AdventureWorksSales.ClueProducers
{
    public class SalesSalesTerritoryHistoryClueProducer : BaseClueProducer<SalesSalesTerritoryHistory>
    {
        ...
        protected override Clue MakeClueImpl(SalesSalesTerritoryHistory input, Guid id)
        {
            ...
            data.Codes.Add(new EntityCode("/SalesSalesTerritoryHistory", AdventureWorksSalesConstants.CodeOrigin, $"{input.BusinessEntityID}.{input.TerritoryID}.{input.StartDate}"));
