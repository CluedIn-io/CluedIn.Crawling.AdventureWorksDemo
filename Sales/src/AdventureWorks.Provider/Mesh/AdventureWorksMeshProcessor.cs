...
{
    public class AdventureWorksSales_Command_MeshProcessor : BaseMeshProcessor
    {
        public AdventureWorksSales_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          AdventureWorksSalesConstants.ProviderId;
