...
{
    public class AdventureWorks_Command_MeshProcessor : BaseMeshProcessor
    {
        public AdventureWorks_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          AdventureWorksConstants.ProviderId;
