...
var clue = _factory.Create("/PersonStateProvince", $"{input.Rowguid}", id);
...
data.Codes.Add(new EntityCode("/PersonStateProvince", AdventureWorksConstants.CodeOrigin, $"{input.StateProvinceID}"));
