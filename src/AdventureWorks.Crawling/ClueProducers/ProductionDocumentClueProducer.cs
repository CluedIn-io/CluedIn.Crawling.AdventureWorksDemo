...
var clue = _factory.Create("/ProductionDocument", $"{input.DocumentNode}", id);
...
{
_factory.CreateOutgoingEntityReference(clue, "/PersonBusinessEntity", EntityEdgeType.AttachedTo, input.Owner, input.Owner.ToString());
}
