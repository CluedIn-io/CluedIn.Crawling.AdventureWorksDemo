...
[DisplayName("Production.TransactionHistoryArchive")]
public class ProductionTransactionHistoryArchive : BaseSqlEntity
{
public ProductionTransactionHistoryArchive (IDataReader reader) : base (reader)
{
if (reader == null)
{
