...
{
    public class AdventureWorksPurchasing_Command_MeshProcessor : BaseMeshProcessor
    {
        public AdventureWorksPurchasing_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          AdventureWorksPurchasingConstants.ProviderId;
