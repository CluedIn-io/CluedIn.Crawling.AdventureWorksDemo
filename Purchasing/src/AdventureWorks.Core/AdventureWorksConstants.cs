...
{
    public class AdventureWorksPurchasingConstants
    {
        ...
        public const string CrawlerDescription = "AdventureWorksPurchasing is a ... to be completed ...";
        ...
        // src\AdventureWorksPurchasing.Provider\Resources\cluedin.png
        ...
        public const string CodeOrigin = "Purchasing";
        public const string ProviderRootCodeValue = "AdventureWorksPurchasing";
        public const string CrawlerName = "AdventureWorksPurchasingCrawler";
        public const string CrawlerComponentName = "AdventureWorksPurchasingCrawler";
        public static readonly Guid ProviderId = Guid.Parse("d3dd9dc7-57a0-43b9-9db3-b06f33d213e0");
        public const string ProviderName = "AdventureWorksPurchasing";
